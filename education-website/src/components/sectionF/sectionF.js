...
<Link to = '/sectionA' style={{textDecoration:'none'}}>F 1.1</Link> 
</div>

<div class="card-body section_a">
<Link to = '/sectionB' style={{textDecoration:'none',}}>F 1.2</Link> 
</div>
<div class="card-body section_a">
<Link to = '/sectionC' style={{textDecoration:'none',}}>F 1.3</Link> 
</div>
<div class="card-body section_a">
<Link to = '/sectionD' style={{textDecoration:'none',}}>F 1.4</Link> 
</div>
<div class="card-body section_a">
<Link to = '/sectionE' style={{textDecoration:'none',}}>F 2.1</Link> 
</div>
<div class="card-body section_a">
<Link to = '/sectionF' style={{textDecoration:'none',}}>F 2.2</Link> 
</div>
</div>
